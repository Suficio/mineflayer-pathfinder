...
- [Mineflayer-Pathfinder](#mineflayer-pathfinder)
  ...
  * [Documentation](#documentation)
    + [bot.pathfinder.to](#botpathfinderto--startpoint--endpoint----enumpathfinder--)
    + [bot.pathfinder.getSuccessors](#botpathfindergetsuccessors--position-)
    + [bot.pathfinder.getPredecessors](#botpathfindergetpredecessors--position-)
    + [bot.pathfinder.getBlock](#botpathfindergetblock--position-)
    + [bot.pathfinder.MAX_EXPANSIONS](#botpathfindermax-expansions)
    + [bot.pathfinder.HEURISTIC](#botpathfinderheuristic--startpoint--endpoint-)
    + [bot.pathfinder.COST](#botpathfindercost--startpoint--endpoint-)
